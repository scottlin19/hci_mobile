...
public class VacuumActions extends Fragment {
    ...
    public static VacuumActions newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView textView = getActivity().findViewById(R.id.battery_level);
        textView.setText(R.string.battery_level);
        // Inflate the layout for this fragment ;)
        return inflater.inflate(R.layout.fragment_vacuum_detail, container, false);
    }
}